...
Use `samconfig.toml` environment-specific sections for multi-environment deployments. See [sam-project-setup.md](sam-project-setup.md) for configuration details.
